...
function Navbar() {
    ...
    return (
        <nav className="navbar" style={{display:navLocations.includes(location.pathname) || (!localStorage.getItem("token") && !localStorage.getItem("admin-token") && location.pathname=="/reviews")?"flex":"none"}}>
